    ...
    <div class="flex min-h-screen">
        <aside class="w-64 bg-white border-r border-gray-100 hidden lg:flex flex-col h-screen sticky top-0">
            ...
            <nav class="mt-4 px-4 space-y-2 flex-1">
                ...
                <a href="{{ route('profile.edit') }}" class="flex items-center px-4 py-3 text-gray-500 hover:bg-gray-50 rounded-xl transition">
                    ...
                    <div class="flex items-center bg-white p-1 pr-4 rounded-full border border-gray-100 shadow-sm">
                        {{-- @php
                            $currentUser = $colocation->users
                                ...
                                ->first();
                        @endphp --}} 
                        <div class="rounded-full bg-gray-900 text-white flex items-center justify-center font-bold"> {{ auth()->user()->name }} </div>
